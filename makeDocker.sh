...
docker build -t spv2/cron:$VERSION -f Dockerfile.db_worker .
...
docker tag spv2/cron:$VERSION 896129387501.dkr.ecr.us-west-2.amazonaws.com/spv2/db_worker:$VERSION
